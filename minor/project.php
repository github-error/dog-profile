    ...
    <div class="dashboard">
        ...
        <ul class="sidebar-menu">
          <li class="dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li><a href="uploadhandler.php"><i class="fas fa-tachometer-alt"></i> upload posts</a></li>
              <li><a href="Upcoming.php"><i class="fas fa-tachometer-alt"></i> upcoming events</a></li>
              <li><a href="statistics.html"><i class="fas fa-chart-line"></i> Statistics</a></li>
              <li><a href="usermanagement.php"><i class="fas fa-users"></i> User Management</a></li>
            </ul>
          </li>
          <li class="dropdown">
      ...
      <div class="main-content">
        ...
        <div class="content">
          ...
          <div>
            <a href="sharepost.php" class="div1">
                <i class="fas fa-comments"></i> Our Social Gathering
            </a>
            <a href="dogstat.php" class="div2">
